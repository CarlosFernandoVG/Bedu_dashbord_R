...
setwd("~/Documents/Courses/Beca Santander BEDU/Fase2/Proyecto")
...
d1011 <- read.csv("RawData/SP1-1011.csv")
d1112 <- read.csv("RawData/SP1-1112.csv")
d1213 <- read.csv("RawData/SP1-1213.csv")
d1314 <- read.csv("RawData/SP1-1314.csv")
d1415 <- read.csv("RawData/SP1-1415.csv")
d1516 <- read.csv("RawData/SP1-1516.csv")
d1617 <- read.csv("RawData/SP1-1617.csv")
d1718 <- read.csv("RawData/SP1-1718.csv")
d1819 <- read.csv("RawData/SP1-1819.csv")
